        ...
        <div className="max-w-[1480px] mx-auto px-5 sm:px-8 mt-28 bg-white dark:bg-black">
            <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-12 pt-20 border-t text-black dark:text-white border-gray-100 dark:border-gray-900 pb-24">
                <div className="lg:col-span-2">
                    <div>
                        <h1 className="mb-4 font-bold text-3xl">{settings?.siteName || 'EliteBlog'}</h1>
                        <p>{settings?.footerText || 'At EliteBlog, we believe that success is built on innovative ideas and practical strategies. Our blog serves as your trusted companion, offering in-depth insights, creative inspiration, and actionable tips to fuel your journey toward extraordinary achievements.'}</p>
                    </div>
                </div>
                <div className="lg:col-span-2">
