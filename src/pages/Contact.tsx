            ...
            <div className="max-w-[1480px] mx-auto px-5 sm:px-8 mb-8 mt-20 text-black dark:text-white">
                ...
                <div className="grid md:grid-cols-2 gap-24">
                    <form className="grid grid-cols-1 gap-6">
                        ...
                        <input className="w-full txtInputBasics h-16 " id="contact-name" name="contact-name" placeholder="Name" autoComplete="off" autoCapitalize="off" spellCheck="false" type="text" pattern="(([a-zA-Z]+( )?)+)" title="Name should consist of alphabets (a to z, A to Z) and single spaces." maxLength={32} minLength={4} />
                        ...
                        <button className="btn relative text-white dark:text-black bg-black dark:bg-white cursor-pointer" type="submit"><span className="">Send</span></button>
                    </form>
                    <div>
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            <div className="flex gap-3 items-center">
                                ...
                                <Link to="mailto:address@yoursite.com">address@yoursite.com</Link>
                            </div>
                            <div className="flex gap-3 items-center">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Link to="tel:+234123-456-789">123-456-789</Link>
                            </div>
                        </div>
                        <h3 className="text-2xl mb-6 mt-12">Socials</h3>
                        <div className="flex gap-5 text-xl heading-color ">
                            <Link to="https://twitter.com/@elite_codec" aria-label="Twitter link" target="_blank" rel="noreferrer">
                            ...
                            <Link to="https://www.linkedin.com/master-daniel" aria-label="LinkedIn link" target="_blank" rel="noreferrer">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"></path>
                                </svg>
                            </Link>
                            <Link to="https://github.com/master-daniel" aria-label="Github link" target="_blank" rel="noreferrer">
